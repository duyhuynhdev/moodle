...
/**
 * Event emitted when user's password is compromised.
 *
 ...
 * }
 */
class user_compromised extends base {
    /**
    ...
    public static function get_name() {
        return get_string('eventusercompromised');
    }
    ...
    public function get_description() {
        return "The user with id '$this->objectid' has been marked as compromised.";
    }
